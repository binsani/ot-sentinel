...
| TLS Syslog SIEM forwarding | RFC 5424 events, explicit destination CIDRs, severity thresholds, retry evidence, and audited outcomes | Supports centralized security monitoring and controlled event integration without exposing the OT sensor |
| Communication graph anomaly detection | Explicit immutable site baselines, new-edge evidence, alerting, and audited acknowledgement | Supports monitoring for unauthorized or unexpected OT communication paths and documented review |
